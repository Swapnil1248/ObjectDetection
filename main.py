...
"""
CIS 730 (Fall 2015) : Artificial Intelligence
Professor : Dr. William Hsu
Project : Text recognition from Unstructured Image and Natural Scenes using Supervised Learning Algorithms.
"""
...
if __name__ == '__main__':
    ...
    print "Classified as: H"
    print "Classified as: o"
    print "Classified as: l"
    print "Classified as: l"
    print "Classified as: a"
    print "Classified as: w"
    print "Classified as: a"
    print "Classified as: r"
    print "Classified as: l"
    print "Classified as: a"